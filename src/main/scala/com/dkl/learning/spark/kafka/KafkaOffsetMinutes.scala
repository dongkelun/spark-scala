...
object KafkaOffsetMinutes {

  def main(args: Array[String]) {

    //创建sparkConf
    val sparkConf = new SparkConf().setAppName("KafkaOffsetMinutes").setMaster("local[2]")
